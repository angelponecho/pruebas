...
namespace Zemba\WorkoutBundle\Controller;
...
use Zemba\WorkoutBundle\Entity\workout;
use Zemba\WorkoutBundle\Form\workoutType;
...
class workoutController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ZembaWorkoutBundle:workout')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ZembaWorkoutBundle:workout')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ZembaWorkoutBundle:workout:edit.html.twig")
     */
